...
function appendRandom(title){
    randomNumDisplay.innerHTML+= `<li><div class="collapsible-header center-align"><span class="random-title">${title}</span>${appendStreaming(pullMovieObjOut(title))}</div>
    <div class="collapsible-body">${appendInfo(pullMovieObjOut(title))}</div></li>`;
}
